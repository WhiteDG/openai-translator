...
export const commands = {
    ...
    async showTranslatorWindowWithSelectedTextAndActionCommand(actionId: string): Promise<void> {
        await TAURI_INVOKE('show_translator_window_with_selected_text_and_action_command', { actionId })
    },
    ...
    async updateLocales(locales: string | null): Promise<null> {
        return await TAURI_INVOKE('update_locales', { locales })
    },
}
